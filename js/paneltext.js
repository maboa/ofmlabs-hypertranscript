  ...
  //LINKS   
			...
			.timeline({
       		start: 21, // seconds
		        ...
		        target: "timeline",
		        title: "<a href='#' id='t21000'>&#x266B;</a>",
		        text: "[twitter.com]",
		        link_text: "@maboa",
				link_href: "http://twitter.com/maboa/"
			 })
			.timeline({
       		start: 25, // seconds
       		end: 1200, // seconds
		        target: "timeline",
		        title: "<a href='#' id='t25000'>&#x266B;</a>",
		        text: "[jPlayer.org]",
		        link_text: "jPlayer",
				link_href: "http://jplayer.org"
			 })
	  		.timeline({
		        start: 38, // seconds
		        end: 1200,// seconds
		        target: "timeline",
		        title: "<a href='#' id='t38000'>&#x266B;</a>",
		        text: "[happyworm.com]",
		        link_text: "Happyworm",
				link_href: "http://happyworm.com"
			})
			.timeline({
		        start: 85, // seconds
		        end: 1200,// seconds
		        target: "timeline",
		        title: "<a href='#' id='t85000'>&#x266B;</a>",
		        text: "[youtube.com]",
		        link_text: "Sinclair ZX Spectrum Game Clips + Music!",
				link_href: "http://www.youtube.com/watch?v=XO5oyUyvDDw"
			})
			.timeline({
		        start: 100, // seconds
		        end: 1200,// seconds
		        target: "timeline",
		        title: "<a href='#' id='t100000'>&#x266B;</a>",
		        text: "[worldofspectrum.org]",
		        link_text: "World of Spectrum Documentation - Chapter 19 (Beep)",
				link_href: "http://www.worldofspectrum.org/ZXBasicManual/zxmanchap19.html"
			})   
		    ...
		    .footnote({
				...
				text: 'Interview with Mark Boas blah blah blah  August 10th, 2011 for <a href="http://www.ofmlabs.com" target="_blank">OFMlabs</a>',
				target: 'footnote'
			})
			.footnote({
			    start: 28, // seconds
				end: 38, // seconds
				text: '"The main author of jPlayer is <a href="http://twitter.com/thepag/">Mark Panaghiston</a>, I am just the chief cook and bottle-washer." - Mark',
				target: 'footnote'
			}) 
			.footnote({
				start: 39, // seconds
				end: 50, // seconds
				text: 'Happyworm is <a href="http://twitter.com/aulentina/">Silvia Benvenuti</a> (Designer), <a href="http://twitter.com/maboa/">Mark Boas</a> (Developer) and <a href="http://twitter.com/thepag/">Mark Panaghiston</a> (Developer)',
				target: 'footnote'
			})
		    .footnote({
				start: 62, // seconds
				end: 72, // seconds
				text: '"I meant <b>400</b> downloads a day, there were approximately 4000 <b>visitors</b> a day in the month of July. I become both excited and confused when it comes to stats." - Mark',
				target: 'footnote'
			})
